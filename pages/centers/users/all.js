...
import AllCenterUSersComp from "../../../components/centers/users/all";


function AllCenterUSers() {
                    ...
                    <div className="col-12 col-lg-11 regMain">
                        ...
                        <div className="row pt-3">
                            ...
                            <div className="col-12 col-lg-10 p-lg-3">
                                <AllCenterUSersComp details={dets} bearer={bearer_key} />
                            </div>
                        </div>
